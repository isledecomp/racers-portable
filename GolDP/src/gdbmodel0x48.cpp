...
void GdbModel0x48::VTable0x1c(undefined4 p_arg1, const LegoChar* p_name, LegoBool32 p_binary)
{
	if (m_unk0x24) {
		VTable0x24();
	}
	IGdbModel0x40::VTable0x1c(p_arg1, p_name, p_binary);
	if (m_unk0x40 != NULL) {
...
)
{
	...
	if (p_arg6 > 0) {
		m_unk0x04.FUN_10025df0(p_arg1, p_arg6);
	}
	switch (p_vertexType) {
	case e_vertexType1:
